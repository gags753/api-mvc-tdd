...
var FakeData = /** @class */ (function () {
    function FakeData() {
        this.createUserService = new CreateUserService_1.CreateUserService();
    }
    FakeData.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createUserService.execute({
                            id: uuid_1.v4(),
                            nome: 'Algum usuário',
    ...
    FakeData.prototype.createUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
